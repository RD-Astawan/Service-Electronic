                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route('add_profile') }}" class="btn btn-primary btn-round ml-auto" style="color: white;">
                            ...
                            <table id="add-row" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <a href="/profile/edit/{{ $row->id_profile }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                                <a href="#modalHapusProfile{{ $row->id_profile }}" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus</a>
                                            </td>
                                        @endforeach
                                    </tr>
...
@foreach ($data as $u)
<div class="modal fade" id="modalHapusProfile{{ $u->id_profile }}" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="get" enctype="multipart/form-data" action="/profile/destroy/{{ $u->id_profile }}">
                @csrf
