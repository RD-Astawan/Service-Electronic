    ...
    <div class="page-inner">
        ...
        <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Modal -->
                        <form method="post" enctype="multipart/form-data" action="/profile/update/{{ $data->id_profile }}">
                            @csrf
                            ...
                            <div class="row">						
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group @error('deskripsi') has-error has-feedback @enderror>
                                        ...
                                        <textarea name="deskripsi" id="" cols="30" rows="5" class="form-control input-square" required>{{ $data->deskripsi }}</textarea>
                                        {{-- @error('deskripsi')
                                            <small class="form-text text-muted">{{ $message }}</small>
                                        @enderror --}}
                                    </div>
