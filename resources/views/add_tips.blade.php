...
<div class="content">
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Management Tips Perawatan</h4>
        ...
        <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Modal -->
                        <form method="post" enctype="multipart/form-data" action="{{ route('save_tips') }}">
                            @csrf
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="list_tips[]" class="form-control input-square" placeholder="" aria-label="" aria-describedby="basic-addon1" required>
