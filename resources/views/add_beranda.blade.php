    ...
    <div class="page-inner">
        ...
        <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- Modal -->
                        <form method="post" enctype="multipart/form-data" action="{{ route('save_beranda') }}">
                            @csrf
                            ...
                            <div class="row">						
                                <div class="col-md-12">
                                    <div class="form-group @error('judul') has-error has-feedback @enderror">
                                        ...
                                        <input type="text" name="judul" value="{{ old('judul') }}" class="form-control input-square" id="squareInput" placeholder="Judul">
                                        @error('judul')
                                    ...
                                    <div class="form-group @error('deskripsi') has-error has-feedback @enderror>
                                        ...
                                        <textarea name="deskripsi" id="" cols="30" rows="5" class="form-control input-square">{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <small class="form-text text-muted">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group @error('gambar') has-error has-feedback @enderror">
                                        <label for="squareInput">Gambar (wajib input gambar ukuran lebar:214px dan tinggi: 140px)</label>
